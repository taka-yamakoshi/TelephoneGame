...
if __name__ == '__main__':
    ...
    if args.corpus == 'bert':
        if 'mixture' in args.sampling_method:
            text_path = f'{os.environ.get("BERT_PATH")}/{args.num_tokens}TokenSents/textfile/{args.model_name}/{args.batch_size}_{args.chain_len}/'\
            +f'bert_new_{args.sampling_method}_{args.sweep_order}_{args.epsilon}{args.mask_init_id}_input_*{args.temp}.csv'
            data_path = f'{os.environ.get("BERT_PATH")}/{args.num_tokens}TokenSents/datafile/{args.model_name}/'\
